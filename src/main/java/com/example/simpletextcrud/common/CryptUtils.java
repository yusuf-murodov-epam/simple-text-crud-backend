...
/**
 * <code>CryptUtils</code> - Encryption and decryption utilities holder.
 */
public final class CryptUtils {
  ...
  /**
   * Get actual encryption key which is used to encrypt inputs.
   * @return the {@link SecretKeySpec} - actual key specs.
   */
   ...
   * @param message a plain text input is to be encrypted.
   * @return the {@link String} encrypted value.
   */
  ...
  /**
   * Decrypt message input.
   * @param message an encrypted text input is to be decrypted.
   * @return the {@link String} original plain text which is decrypted.
   */
   ...
   * Decrypt message input.
   * @param message an encrypted text input is to be decrypted.
   * @param clazz return decrypting type.
   * @return T original plain text which is decrypted.
   */
